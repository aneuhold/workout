...
The user is requesting the following component(s): $ARGUMENTS
...
7. **Create Storybook stories**
   ...
   - Make sure to understand the Storybook story guidelines in `.claude/CLAUDE.md` before writing stories
