...
- "Next Up" section that has quick access to continue a session that is currently running, or start the next session. Should have some basic info on the upcoming session.
